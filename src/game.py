...
from src.entities.building import Building, BuildingType
...
class Game:
    ...
    def render(self):
        """Render the game"""
        self.renderer.render_world(self.world, self.workers, self.buildings)
    ...
    def _initialize_game_content(self):
        ...
        print("Charlie the builder will construct buildings as needed!")
        print("Building priority: House -> Warehouse -> More Houses -> Farm -> Workshop -> Well")
